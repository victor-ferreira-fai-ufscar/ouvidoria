...
FAIS = [
    ...
    {"sigla": "FUNRIO", "nome": "Fundação de Apoio à Pesquisa e Extensão", "instituicao": "UFRJ", "uf": "RJ", "esfera": "Federal", "site": "", "ouvidoria": "A verificar", "canal_url": "", "status": "Pendente", "obs": "Busca inicial não localizou site/canal próprio com confiança (homônimo com organizadora de concursos); reconfirmar."},
    ...
    {"sigla": "ADM", "nome": "Fundação Escola de Administração", "instituicao": "UFBA", "uf": "BA", "esfera": "Federal", "site": "", "ouvidoria": "A verificar", "canal_url": "", "status": "Pendente", "obs": "Vínculo a esclarecer: a UFBA afirma que a Fundação Escola de Administração da Bahia (FEA-BA) NÃO é sua fundação de apoio."},
    {"sigla": "ASTEF", "nome": "Fundação ASTEF / FASTEF (Apoio a Serviços Técnicos, Ensino e Fomento a Pesquisas)", "instituicao": "UFC", "uf": "CE", "esfera": "Federal", "site": "https://fastef.ufc.br", "ouvidoria": "A verificar", "canal_url": "", "status": "Pendente", "obs": "A ASTEF instituiu a FASTEF (fundação de apoio à UFC); tem Acesso à Informação institucional; canal de ouvidoria próprio a confirmar."},
    ...
    {"sigla": "FUCAM", "nome": "Fundação de Apoio Cassiano Antônio Moraes", "instituicao": "UFES", "uf": "ES", "esfera": "Federal", "site": "http://fucam.org.br", "ouvidoria": "A verificar", "canal_url": "", "status": "Pendente", "obs": "Ligada ao HUCAM/UFES. (A antiga Fundação Ceciliano Abel de Almeida está em liquidação judicial.) Canal próprio a confirmar."},
